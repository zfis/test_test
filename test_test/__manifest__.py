# -*- coding: utf-8 -*-
{
    ...
    'data':[
        ...
        'wizard/duepayment.xml','wizard/salesperson_sales.xml',
        ...
        'sequences/reservation_sequence.xml','report/report_sample.xml','report/templates/report_reservation.xml',
        'report/templates/report_ownership_contract.xml',
        'report/templates/report_release_contract.xml',
        'report/templates/rental_contract.xml','report/templates/sales_representatives.xml',
        'report/templates/occupany.xml',
        'report/templates/due_payments_customers.xml',
        'report/templates/due_payments_units.xml',
        'report/templates/late_payments_customers.xml','report/templates/late_payments_units.xml','report/templates/report_quittance_letter.xml',
